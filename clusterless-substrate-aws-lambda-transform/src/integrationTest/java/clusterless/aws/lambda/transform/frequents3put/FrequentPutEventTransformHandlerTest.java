 ...
 */
@TestWithResources
public class FrequentPutEventTransformHandlerTest extends LocalStackBase {
    @WithJacksonMapper
    ...
    @Override
    protected FrequentS3PutTransformProps getProps() {
        return FrequentS3PutTransformProps.builder()
    ...
    void invoke(
        ...
        FrequentPutEventTransformHandler handler = new FrequentPutEventTransformHandler();

        FrequentPutEventTransformObserver eventContext = mock();
