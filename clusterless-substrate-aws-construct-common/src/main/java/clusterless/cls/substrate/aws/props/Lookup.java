...
public class Lookup {
    public static Architecture architecture(clusterless.cls.substrate.aws.props.Architecture architecture) {
        switch (architecture) {
            case ARM_64: {
    ...
    public static Platform platform(clusterless.cls.substrate.aws.props.Architecture architecture) {
        switch (architecture) {
            case ARM_64: {
