...
import clusterless.cls.substrate.aws.arc.state.ArcCompleteStateGate;
import clusterless.cls.substrate.aws.arc.state.ArcStartStateGate;
...
public class ArcOrchestration extends ManagedConstruct implements Orchestration {
    ...
    private IChainable stateFrom(ArcComponent arcComponent, IChainable fail) {
        ...
        return ((ArcConstruct<?>) arcComponent)
                .createState(
                        ArcStateContext.WORKLOAD_CONTEXT_PATH,
                        ArcStateContext.SINK_MANIFESTS_PATH,
                        fail,
