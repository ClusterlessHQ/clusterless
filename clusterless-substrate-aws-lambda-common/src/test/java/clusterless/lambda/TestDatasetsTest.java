...
public class TestDatasetsTest {
    ...
    void manifestsPaths() {
        ...
        assertTrue(new TestDatasets("main").manifestPathMap().get("main").uri().toString().endsWith("/"));
    ...
    void manifests() {
        ...
        assertTrue(new TestDatasets("main").manifestIdentifierMap("20230227PT5M287", ManifestState.complete).get("main").uri().toString().endsWith("manifest.json"));
