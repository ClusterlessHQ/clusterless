...
public class ClusterlessProjectTask extends BaseSimpleTask {
    public ClusterlessProjectTask(String taskDefName, String taskReferenceName, Path workingDirectory, List<Path> projectFiles) {
