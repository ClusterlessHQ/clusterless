...
public class StateURITest {
    ...
    void arcState() {
        ...
        Assertions.assertEquals(URI.create("s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/"), arcState.uri());

        String template = arcState.template();
        Assertions.assertEquals("s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/lot={lot}/{state}.arc", template);
        ...
        Assertions.assertTrue(arcState.isPath());
        Assertions.assertEquals(URI.create("s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/lot=20211112PT5M000/"), arcState.uri());

        arcState = arcState.withState(ArcState.running);

        Assertions.assertTrue(arcState.isIdentifier());
        Assertions.assertEquals(URI.create("s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/lot=20211112PT5M000/running.arc"), arcState.uri());

        arcState = arcState.withState(ArcState.complete);

        Assertions.assertTrue(arcState.isIdentifier());
        Assertions.assertEquals(URI.create("s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/lot=20211112PT5M000/complete.arc"), arcState.uri());

        template = arcState.template();
        Assertions.assertEquals("s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/lot=20211112PT5M000/complete.arc", template);
        ...
        Assertions.assertEquals("\"s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/lot=20211112PT5M000/complete.arc\"", jsonFromRaw);

        String jsonFromParsed = JSONUtil.writeAsStringSafe(parsedArcState);
        Assertions.assertEquals("\"s3://prod-clusterless-arc-state-00000000-us-west-2/arcs/name=test-project/version=20230101/arc=arc1/lot=20211112PT5M000/complete.arc\"", jsonFromParsed);
    }
